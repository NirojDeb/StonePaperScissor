...
const BlogPage = () => import('@/views/blogs.vue');

const AddPostPage = () => import('@/views/add-post.vue');

const FullBlogPage = () => import('@/views/blog.vue');
...
const PangotPage = () => {
  if (isMobileOnly) {
    return import('@/views/desktop/campaigns/pangot.vue');
  }
  return import('@/views/desktop/campaigns/pangot.vue');
};
const AboutPage = () => {
  if (isMobileOnly) {
    return import('@/views/desktop/campaigns/About.vue');
  }
  return import('@/views/desktop/campaigns/About.vue');
};
