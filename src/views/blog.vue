<template>
    ...
    <div class="w-full border-b border-grey-dark pb-2">
                <h1 @click="run()" class="text-blue-darker text-center">{{article[id].title}}</h1>
                <div class="border-b border-grey pb-2 pt-1 text-blue-darker text-center text-xs"><span>{{article[id].date}}&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Posted by</span>
