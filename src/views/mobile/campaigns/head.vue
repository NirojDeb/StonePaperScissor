      ...
      <div class="w-full px-4 mx-auto flex flex-wrap items-center justify-between mt-0 py-2 gradient formHead">
         <router-link to="home">
            <div class="flex items-center">
               ...
               <a class="algerian small-font toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-3xl" href="#">
               {{companyDetail.companyDetail.name}}
               </a>
            </div>
         </router-link>
         <div class="nav w-full flex-grow  lg:items-center lg:w-auto  mt-2 lg:mt-0  text-black p-4 lg:p-0 z-20" id="nav-content">
            <ul class="nav list-reset justify-end flex-1 items-center">
               <li>
               ...
               <li>
                  <router-link to="/about" class="algerian inline-block py-2 px-1 text-white font-bold no-underline">
                     About
                  </router-link>
               </li>
               <li>
               ...
               <li>
                  ...
                  <router-link to = "/pangot" class="algerian inline-block text-white no-underline font-bold hover:text-gray-800 hover:text-underline py-2 px-1">Travel</router-link>
               </li>
            </ul>
            <button id="navAction" class="mx-2 lg:mx-0 hover:underline bg-white font-bold text-gray-800
               font-bold rounded-full mt-4 lg:mt-0 py-3 shadow opacity-75">
         ...
         <div class="sidebar lg:hidden" style="right:-250px;top:0px;" id="rightMenu">
            ...
            <router-link to="/dashboard" class="no-underline"><button class="side-button"><i class="fa fa-home"></i> Home</button></router-link>
            <router-link to="/about" class="no-underline"><button class="side-button"><i class="far fa-address-card"></i> About Us</button></router-link>
