...
export default {
  ...
  computed: {
    ...mapGetters(['articles', 'articleSkipQuery', 'totalArticlesCount', 'categories']),
    categoryName() {
  ...
  methods: {
    ...mapActions(['fetchAllArticles', 'fetchArticleComments', 'articleLike', 'unlikeArticle', 'commentOnArticle']),
    fetchData() {
